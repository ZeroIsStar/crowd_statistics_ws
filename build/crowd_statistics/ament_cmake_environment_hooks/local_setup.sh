...
: ${AMENT_CURRENT_PREFIX:="/capella/lib/python3.10/site-packages/crowd_statistics_ws/install/crowd_statistics"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crowd_statistics/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crowd_statistics/environment/path.sh"
